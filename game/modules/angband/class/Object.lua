...
function _M:getPowerRank()
	if self.unique then return 2 end
...
_M.tval_table = {
	...
	[39] = {"light", slot="LITE", wielder={lite=2}},
	[40] = {"amulet", slot="NECK", name_gen=function(e) return "& Amulet~ of "..e.name end},
	[45] = {"ring", slot="FINGER", name_gen=function(e) return "& Ring~ of "..e.name end},
	[55] = {"staff", name_gen=function(e) return "& Staff~ of "..e.name end},
	[65] = {"wand", name_gen=function(e) return "& Wand~ of "..e.name end},
	[66] = {"rod", name_gen=function(e) return "& Rod~ of "..e.name end},
	[70] = {"scroll", name_gen=function(e) return "& Scroll~ of "..e.name end},
	[75] = {"potion", random_color=true, name_gen=function(e) return "& Potion~ of "..e.name end},
	[77] = {"flask"},
	[80] = {"food", random_color=true},
	[90] = {"magic book", name_gen=function(e) return "& Magic Book~ ["..e.name.."]" end},
	[91] = {"prayer book", name_gen=function(e) return "& Prayer Book~ ["..e.name.."]" end},
	[100] = {"gold"},
}
