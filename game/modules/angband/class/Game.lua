...
function _M:run()
	...
	self.log(self.flash.GOOD, "Welcome to #00FF00#the Pits of Angband!")
...
function _M:loaded()
	...
	Map:setViewerActor(self.player)
	Map:setViewPort(200, 20, self.w - 200, math.floor(self.h * 0.80) - 20, 12, 16, "/data/font/FSEX300.ttf", 16, true)
