...
grass_wm = { method="borders", type="grass", forbid={lava=true},
	default8={alternear={y=-1,alterbase=true,add_mos={{image="terrain/grass_worldmap/nsand_under_grass_2_%02d.png"}}, min=1, max=1}, add_mos={{image="terrain/grass_worldmap/grass_2_%02d.png", display_y=-1}}, min=1, max=2},
	default2={add_mos={{image="terrain/grass_worldmap/grass_8_%02d.png", display_y=1}}, min=1, max=2},
	default4={alternear={x=-1,alterbase=true,add_mos={{image="terrain/grass_worldmap/nsand_under_grass_6_%02d.png"}}, min=1, max=1}, add_mos={{image="terrain/grass_worldmap/grass_6_%02d.png", display_x=-1}}, min=1, max=2},
	default6={alternear={x=1,alterbase=true,add_mos={{image="terrain/grass_worldmap/nsand_under_grass_4_%02d.png"}}, min=1, max=1}, add_mos={{image="terrain/grass_worldmap/grass_4_%02d.png", display_x=1}}, min=1, max=2},
	...
	default7={alternear={x=-1,y=-1,alterbase=true,add_mos={{image="terrain/grass_worldmap/nsand_under_grass_3_%02d.png"}}, min=1, max=1}, z=3,add_mos={{image="terrain/grass_worldmap/grass_3_%02d.png", display_x=-1, display_y=-1}}, min=1, max=1},
	default9={alternear={x=1,y=-1,alterbase=true,add_mos={{image="terrain/grass_worldmap/nsand_under_grass_1_%02d.png"}}, min=1, max=1}, z=3,add_mos={{image="terrain/grass_worldmap/grass_1_%02d.png", display_x=1, display_y=-1}}, min=1, max=1},
