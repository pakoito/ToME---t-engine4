...
newChat{ id="training",
	text = [[I can indeed offer some martial training (talent type Technique/Combat-training) for a fee of 50 gold pieces or the basic usage of bows and slings (Shoot talent) for 8 gold pieces.]],
	answers = {
