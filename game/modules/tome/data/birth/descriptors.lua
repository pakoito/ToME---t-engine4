...
newBirthDescriptor{
	...
	copy = {
		...
		resolvers.inventory{ id=true,
			{type="scroll", subtype="infusion", name="infusion of healing", ego_chance=-1000},
			{type="scroll", subtype="infusion", name="infusion of cure", ego_chance=-1000},
			{type="scroll", subtype="infusion", name="infusion of movement", ego_chance=-1000},
			{type="scroll", subtype="infusion", name="infusion of pain suppression", ego_chance=-1000},
			{type="scroll", subtype="rune", name="rune of light", ego_chance=-1000},
			{type="scroll", subtype="rune", name="rune of vision", ego_chance=-1000},
			{type="scroll", subtype="rune", name="rune of speed", ego_chance=-1000},
			{type="scroll", subtype="rune", name="rune of controlled phase door", ego_chance=-1000},
			{type="scroll", subtype="rune", name="rune of phase door", ego_chance=-1000},
			{type="scroll", subtype="rune", name="rune of teleportation", ego_chance=-1000},
			{type="scroll", subtype="rune", name="rune of shielding", ego_chance=-1000},
