...
newTalent{
	...
	type = {"chronomancy/advanced-timetravel", 1},
	require = chrono_req1,
	points = 5,
	random_ego = "attack",
	mana = 10,
...
newTalent{
	name = "Tighten Timecord",
	type = {"chronomancy/advanced-timetravel", 2},
	require = chrono_req2,
	points = 5,
	random_ego = "attack",
	mana = 40,
...
newTalent{
	...
	type = {"chronomancy/advanced-timetravel",3},
	require = chrono_req3,
	points = 5,
	mode = "sustained",
	cooldown = 10,
...
newTalent{
	name = "Time Stop",
	type = {"chronomancy/advanced-timetravel", 4},
	require = chrono_req4,
	points = 5,
	mode = "sustained",
	sustain_mana = 170,
