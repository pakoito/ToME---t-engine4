...
newTalent{
	name = "Destabilize Lifeline",
	type = {"chronomancy/threading", 1},
	require = chrono_req1,
	points = 5,
	random_ego = "attack",
	mana = 10,
...
newTalent{
	name = "Temporal Double?",
	type = {"chronomancy/threading", 2},
	require = chrono_req2,
	points = 5,
	random_ego = "attack",
	mana = 40,
