...
--	all_remembered = true,
	...
	day_night = true,
	persistent = "zone",
	color_shown = is_crystaline and {0.7, 0.7, 0.7, 1} or {0.85, 0.85, 0.85, 1},
	color_obscure = is_crystaline and {0.7*0.6, 0.7*0.6, 0.7*0.6, 0.6} or {0.85*0.6, 0.85*0.6, 0.85*0.6, 0.6},
