...
newEntity{ base = "BASE_SHIELD",
	...
	desc = [[This huge shield made of the darkest stralite is huge, heavy and very solid.]],
	color = colors.GREY,
	level_range = {20, 30},
	rarity = 270,
	require = { stat = { str=37 }, },
...
newEntity{ base = "BASE_GREATMAUL",
	...
	desc = [[The legendary hammer of the dwarven master smiths. For ages it was used to forge powerful weapons with searing heat until it became of high power by itself.]],
	level_range = {38, 50},
	rarity = 250,
	require = { stat = { str=48 }, },
	cost = 650,
...
newEntity{ base = "BASE_CLOTH_ARMOR",
	...
	desc = [[Thie set of robes is made wholly of spider silk. It looks outlandish and some sages think it came from an other world, probably through a farportal.]],
	level_range = {20, 30},
	rarity = 190,
	cost = 250,
	material_level = 3,
...
newEntity{ base = "BASE_LEATHER_BELT",
	...
	desc = [[The simplest of belts, worn for centuries by Nessilla Tantaelen as she tended to her people and forests. Some of her wisdom and power has settled permanently into its fibers.]],
	color = colors.LIGHT_RED,
	level_range = {20, 30},
	rarity = 200,
	cost = 450,
...
newEntity{ base = "BASE_HEAVY_ARMOR",
	...
	desc = [[A heavy shirt of scale mail constructed from the remains of Kroltar, whose armor was like tenfold shields.]],
	color = colors.LIGHT_RED,
	metallic = false,
	level_range = {38, 45},
	rarity = 300,
...
newEntity{ base = "BASE_WARAXE",
	...
	desc = [[The mighty axe can cleave through armor like the sharpest swords, yet hit with all the impact of a heavy club.
