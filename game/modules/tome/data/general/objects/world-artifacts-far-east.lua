...
newEntity{ base = "BASE_AMULET",
	...
	unique = true,
	name = "Pendent of the Sun and Moons", color = colors.LIGHT_SLATE,
	unided_name = "a gray and gold pendent",
	desc = [[This small pendent depicts a hematite moons eclipsing a golden sun and according to legend was worn by one of the Sunwall's founders.]],
	level_range = {35, 45},
	rarity = 300,
	cost = 200,
	material_level = 4,
